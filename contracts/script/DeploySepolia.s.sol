...
/// @notice Deploys StakeToken, RewardToken and StakingVault to Ethereum Sepolia, then funds the
/// vault's rewards pool from the deployer. Run with:
...
contract DeploySepolia is Script {
    ...
    function run() external returns (StakeToken stakeToken, RewardToken rewardToken, StakingVault vault) {
        ...
        console.log("---");
        console.log("Sepolia explorer: https://sepolia.etherscan.io/address/", address(vault));
    }
}
